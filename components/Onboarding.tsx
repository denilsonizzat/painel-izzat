...
const STEPS = [
  ...
  },
  {
    emoji: "🧭",
    titulo: "Menu Lateral",
    descricao: "O menu à esquerda é sua central de navegação. Acesse Dashboard, Meu Dia, Tarefas e muito mais.",
    dica: "No desktop, você pode recolher o menu clicando na seta para ter mais espaço de trabalho.",
  },
  {
    emoji: "☀️",
    titulo: "Meu Dia",
    descricao: "Todo dia, abra Meu Dia para marcar suas rotinas, registrar atividades e acompanhar suas entregas da semana.",
    dica: "Cada rotina ou tarefa concluída gera XP. Seu nível sobe conforme você acumula pontos.",
  },
  {
    emoji: "🍅",
    titulo: "Timer Pomodoro",
    descricao: "O botão 🍅 no canto inferior direito ativa o Pomodoro — técnica de foco de 25 minutos seguida de descanso.",
    dica: "Clique em 🍅 em qualquer tarefa ou rotina para iniciar automaticamente com aquele item pré-selecionado.",
  },
  {
    emoji: "⚡",
    titulo: "Sistema de XP e Níveis",
    descricao: "Cada ação gera XP: +10 subtarefa, +25 Pomodoro, +30 tarefa, +50 check-in diário. Suba de Iniciante até Lendário.",
