...
import { datasDoPais } from "@/lib/ferramentas";
...
export default function CalendarioPage() {
  ...
  return (
    <div className="mx-auto space-y-5">
      ...
      <div>
        <h1 className="text-2xl font-bold text-white flex items-center gap-2"><CalendarDays size={22} style={{ color: "#c9a84c" }} /> Calendário de Datas</h1>
        <p className="text-sm mt-0.5" style={{ color: "#9aa7ba" }}>Datas comemorativas e-commerce por mercado · 🌐 global · 📍 local · ~ data móvel</p>
      </div>
