    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex items-start justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2">
          {totalTravados > 0 && (
            <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl" style={{ background: "#ef444418", border: "1px solid #ef444430" }}>
              <AlertTriangle size={14} style={{ color: "#ef4444" }} />
              <span className="text-sm font-bold" style={{ color: "#ef4444" }}>{totalTravados} travado{totalTravados > 1 ? "s" : ""}</span>
            </div>
          )}
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl" style={{ background: "#10b98118", border: "1px solid #10b98130" }}>
